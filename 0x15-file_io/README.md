This is for the description of each file in this directory `0x15-file_io`.
...
`3-cp.c` > is a source code file for a function that copies the content of a file to another file.
